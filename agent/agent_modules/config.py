...
DOWNLOAD_MAX_RETRIES = int(os.getenv("RECALL_DOWNLOAD_MAX_RETRIES", "3"))
DOWNLOAD_RETRY_BACKOFF_SECONDS = float(os.getenv("RECALL_DOWNLOAD_RETRY_BACKOFF_SECONDS", "1.0"))
